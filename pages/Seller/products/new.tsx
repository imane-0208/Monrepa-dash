        ...
        <div className="w-3/4">
          ...
          <div className="w-full flex justify-between items-end">
            ...
            <PrimaryBtn
              ...
              className="px-5 bg-red-500 text-white hover:text-white hover:bg-red-900 "
            >
              Ajouter des images
            </PrimaryBtn>
            <input
            ...
            {sliderImages.map((_, i) => (
              ...
              >
                <div
                  ...
                  className={`p-16 rounded bg-slate-300 cursor-pointer border-red-600  border-solid ${
          ...
          <div className="w-full flex justify-end mt-5">
              <PrimaryBtn
                ...
                className="w-24  bg-red-700 text-white hover:text-white hover:bg-red-900 "
              >
                Enregister
              </PrimaryBtn>
            </div>
